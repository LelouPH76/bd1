...
if (!empty($pagina)) {
                ...
                <tbody>";
                    while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $dados .= "<tr>
                                ...
                                <td class='d-flex'>
                                    <button type='button' id='botao_editar$id' class='btn btn-warning btn-sm me-1' onclick='editar_registro($id)'>Editar $id</button>
                                    <button type='button' id='botao_salvar$id' class='btn btn-warning btn-sm me-1' onclick='salvar_registro($id)'>Salvar $id</button>
                                </td>
                            </tr>";
                    }
 ...
 >Erro: Nenhum usuário encontrado! </div>"];
}
